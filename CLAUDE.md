...
| **오픽톡닥_런칭_마스터플랜.md** | ~14KB | 사업/행정/결제 | 브랜드(3T 시스템, 캐릭터), 결제(포트원, KG이니시스, 카카오페이), PG사 계약 현황, 사업자 정보 | 결제 연동, PG사 계약 확인 시 |
...
**현재**: Phase 3 (핵심 모듈 이관) 진입 — Step 0 대기
**다음 작업**: master_questions + custom_mode_questions DB 설계
