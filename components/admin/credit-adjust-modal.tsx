...
const CREDIT_TYPES = [
  { value: "mock_exam_credits", label: "모의고사 (영구)" },
  { value: "script_credits", label: "스크립트 (영구)" },
  { value: "plan_mock_exam_credits", label: "모의고사 (플랜)" },
  { value: "plan_script_credits", label: "스크립트 (플랜)" },
] as const;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="w-full max-w-md rounded-xl border border-border bg-surface p-6 shadow-xl">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-bold text-foreground">크레딧 조정</h3>
